#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""KernelSU 三星适配补丁 (S21/o1q SM-G9910 5.4 内核, KNOX 魔改 SELinux)
1) sepolicy.c: add_filename_trans 改用三星老式 filename_trans API
2) rules.c: get_policydb 改用 selinux_state.ss (三星无 5.9+ 的 policy 指针)
